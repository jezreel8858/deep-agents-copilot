...
| Router Java Legado Struts | [`backend/struts/struts-router.agent.md`](backend/struts/struts-router.agent.md) | Supervisor hierárquico — orquestra e despacha para os 7 especialistas Java Legado Struts |
